    ...
    <div className="w-full">
      ...
      <div className="bg-[#fff5f7] border-b border-gray-100 py-2 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-[11px] font-bold text-[#e91e63] uppercase tracking-wider">
          <div>Khuyến mãi mùa mới lên đến 30% Off</div>
          <div className="flex gap-6">
            <a href="#" className="hover:text-black transition-colors">Thanh toán</a>
            <a href="#" className="hover:text-black transition-colors">Yêu thích</a>
            <a href="#" className="hover:text-black transition-colors">Tài khoản</a>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#e91e63] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-center py-4 space-x-12">
          {[
            ...
            <a key={item.label} href={item.href} className="text-white text-[12px] font-bold uppercase tracking-widest hover:text-pink-200 transition-colors">
              {item.label}
            </a>
          ))}
        </div>
