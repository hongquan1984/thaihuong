    ...
    <section className="py-20 bg-[#fff5f7]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <p className="text-xs font-black text-[#e91e63] uppercase tracking-[0.3em] mb-3">Phản hồi khách hàng</p>
          <h3 className="font-script text-6xl text-gray-900 lowercase">Khách hàng nói về chúng tôi</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((item, idx) => (
            <div key={idx} className="bg-white p-10 rounded-[45px] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.03)] border border-pink-50 relative group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="mb-8">
                <svg className="w-10 h-10 text-pink-100 mb-4" fill="currentColor" viewBox="0 0 24 24">
